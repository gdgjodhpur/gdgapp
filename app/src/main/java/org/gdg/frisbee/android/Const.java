...
public class Const {
    ...
    public static final String SETTINGS_ME_ORGANIZER = "me_organizer_of_gdg_home";
    public static final String SETTINGS_FIRST_ME_ORGANIZER = "first_me_organizer_of_gdg_home";
    public static final String SETTINGS_ME_ORGANIZER_GDG_IDS = "me_organizer_gdg_ids";
